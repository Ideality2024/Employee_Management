            ...
            <div className="Raj overflow-hidden">
                ...
                <div className="container w-[95%] md:m-[65px] p-[15px] flex md:flex-row flex-col-reverse justify-center items-center shadow ">
                    <div className="raj-content flex-1 md:w-[600px] m-[0px,25px] ">
                        ...
                        <p className='md:text-[20px] mt-3 md:mt-0 leading-1.5 text-[#666] inline'>E Krishak is an e-commerce and Research & Development organization, which designs and develops mobile applications, websites and IoT based electronics solutions for various sectors like agriculture, home automation, robotics etc.
                        ...
                        <button onClick={()=>setShow(!show)} className="text-orange-400 inline ml-2" >Show More</button>
                        <div className={`moreInfo block mt-[20px] ${show?"hidden" : "block"}`}>
                            <h2>Our Mission</h2>
