    ...
    <div>
      <div className="Raj overflow-hidden">
        <div className="heading">
            <h1 className='text-orange-500 text-center mt-[35px] text-[55px]'>
                About Us
            </h1>
        </div>
        <div className="container w-[95%] m-[65px] p-[15px] flex justify-center items-center shadow ">
            <div className="raj-content flex-1 w-[600px] m-[0px,25px] ">
                <h2 className='mb-[20px] text-[#333] text-[28px]'>Welcome to  E-krishak & Ideality company! We are dedicated to providing Website and Mobile Application Developoment to our customers.</h2>
                <h4>
                ...
                <p className='text-[20px] leading-1.5 text-[#666] '>E Krishak is an e-commerce and Research & Development organization, which designs and develops mobile applications, websites and IoT based electronics solutions for various sectors like agriculture, home automation, robotics etc.
                ...
                <button className="cta-button inline-block bg-orange-500 p-[12px,24px] rounded text-[20px] border-none cursor-pointer duration-0.3s ease-in hover:bg-orange-500 scale-[1.1] " id="toggleButton">Show More</button>
            ...
            <div className="img flex-1 w-[50px] m-auto h-[50%]">
