...
const Contact = () => {
  ...
  return (
    <div className="flex flex-column ">
      <div>
        <h1 className='h1 text-center md:text-left mt-4 md:mt-0'>Contact us</h1>
      </div>
      <div className='md:flex w-[100%] justify-around gap-5'>
        ...
        <div className='md:mx-0 md:w-[50%] mx-2 mr-3 bg-blue-100 mb-5 rounded card shadow-lg'><form>
